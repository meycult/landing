    ...
    <div className="sm:hidden fixed z-50 top-3 w-[calc(100vw-1rem)] left-2 min-w-0">
      ...
      >
        <Link href="/" className="flex items-center gap-2 flex-shrink-0">
          ...
          <div className="leading-none">
            <div className="text-sm font-bold tracking-wider" style={{ fontFamily: 'var(--font-logo)' }}>
              ...
              <span className="brand-cult" style={{ textShadow: '0 0 10px rgba(255,255,255,0.3)' }}>Cult</span>
            </div>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <span className="inline-block rounded-lg p-[2px]" style={{ background: 'linear-gradient(135deg, #FFE600, #FFF7A1)' }}>
            <a
              href="https://app.meycult.com"
              className="block px-2.5 py-1.5 rounded-[6px] font-bold text-[9px] uppercase tracking-wider"
              style={{ background: 'linear-gradient(135deg, #0B0A02, #4A3D00)', color: '#ffffff' }}>
              Enter
            </a>
          </span>
        </div>
